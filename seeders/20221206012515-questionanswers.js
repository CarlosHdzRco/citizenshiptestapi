  ...
  async up (queryInterface, Sequelize) {
    await queryInterface.bulkInsert('questionanswers', [
      ...
      },
      {
        ...
        answer: ['Answer will vary.'],
        type: 1,
        wrongAns: ['Los Angeles', 'Augusta', 'Stockton', 'St. Petersburg', 'Fort Wayne', 'Milwuakee', 'Tulsa', 'Modesto', 'Plano', 'Charlotte'],
        spanishQuestion: '¿Cuál es la capital de tu estado?',
        spanishAnswer: ['La respuesta variará.'],
        spanishWrongAns: ['Los Angeles', 'Augusta', 'Stockton', 'St. Petersburg', 'Fort Wayne', 'Milwuakee', 'Tulsa', 'Modeston', 'Plano', 'Charlotte' ],
        category: 'American Government',
        subcategory: 'System of Government',
        createdAt: new Date(),
        updatedAt: new Date()
      ...
      },
      {
        ...
        spanishWrongAns: ['Derecho a servir en un jurado', 'Libertad para postularse para un cargo federal', 'Derecho a votar sin impuestos electorales'],
        category: 'American Government',
        subcategory: 'Rights and Responsibilities',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['Partido politico del presidente', 'Estatua de la Libertad', 'Himno Nacional'],
        category: 'American Government',
        subcategory: 'Rights and Responsibilities',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishAnswer: ['Renunciar a la lealtad a otros países', 'Defender la Constitución y las leyes de los Estados Unidos', 'Obedecer las leyes de los Estados Unidos', 'Servir en las fuerzas armadas de los EE. UU. (si es necesario)'],
        spanishWrongAns: ['Nunca salir de EE.UU.', 'Pague impuestos por viajar a otros países', 'Aprende inglés'],
        category: 'American Government',
        subcategory: 'Rights and Responsibilities',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['Menores de 18 años', '16 y mayores', '30 y mayores'],
        category: 'American Government',
        subcategory: 'Rights and Responsibilities',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        answer: ['Vote', 'Join a political party', 'Help with a campaign', 'Join a community group', 'Call Senators and Representatives', 'Run for office'],
        type: 2,
        ...
        spanishAnswer: ['Vote', 'Únase a un partido político', 'Ayuda con una campaña', 'Únase a un grupo comunitario', 'Llame a senadores y representantes', 'Presentarse como candidato'],
        spanishWrongAns: ['Solicitar un trabajo', 'Comprar bienes raíces', 'Comprar un automóvil'],
        category: 'American Government',
        subcategory: 'Rights and Responsibilities',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['14 de febrero', '1 de abril', '5 de mayo'],
        category: 'American Government',
        subcategory: 'Rights and Responsibilities',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['A los 21 años', 'A los 15 años', 'A los 30 años'],
        category: 'American Government',
        subcategory: 'Rights and Responsibilities',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['Esclavitud', 'Comunismo', 'Establecer monarquía propia'],
      ...
      },
      {
        ...
        spanishWrongAns: ['Africanos ','Rusos ','Asiáticos'],
        category: 'American History',
        subcategory: 'Colonial Period and Independence',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['Indios nativos', 'Europeos', 'Asiáticos'],
        category: 'American History',
        subcategory: 'Colonial Period and Independence',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['Para poner fin a la esclavitud', 'Por el poder sobre el territorio de Luisiana', 'Por té gratis'],
        category: 'American History',
        subcategory: 'Colonial Period and Independence',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['John Adams', 'Abraham Lincoln', 'George Washington'],
        category: 'American History',
        subcategory: 'Colonial Period and Independence',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['8 de junio de 1776', '1 de agosto de 1789', '1 de abril de 1767'],
        category: 'American History',
        subcategory: 'Colonial Period and Independence',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        answer: ['New Hampshire, Massachusetts, Rhode Island', 'Connecticut, New York, New Jersey', 'Pennsylvania, Delaware, Maryland', 'Virginia, North Carolina, South Carolina'],
        type: 1,
        wrongAns: ['Tennessee, Rhode Island, Connecticut', 'Alabama, Vermont, Delaware', 'Kentucky, Virginia, California'],
        spanishQuestion: 'Había 13 estados originales. Nombra tres.',
        spanishAnswer: ['New Hampshire, Massachusetts, Rhode Island', 'Connecticut, New York, New Jersey', 'Pennsylvania, Delaware, Maryland', 'Virginia, North Carolina, South Carolina'],
        spanishWrongAns: ['Tennessee, Rhode Island, Connecticut', 'Alabama, Vermont, Delaware', 'Kentucky, Virginia, California'],
        category: 'American History',
        subcategory: 'Colonial Period and Independence',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['Los esclavos fueron liberados', 'George Washington fue elegido', 'El Himno Nacional fue escrito'],
        category: 'American History',
        subcategory: 'Colonial Period and Independence',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishAnswer: ['1787'],
        spanishWrongAns: ['1750', '1812', '1830'],
        category: 'American History',
        subcategory: 'Colonial Period and Independence',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['George Washington', 'John Adams', 'Abraham Lincoln'],
        category: 'American History',
        subcategory: 'Colonial Period and Independence',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['Presidente de los Estados Unidos', 'Liberó a los esclavos', 'Otorgó a las mujeres el derecho al voto'],
        category: 'American History',
        subcategory: 'Colonial Period and Independence',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['Abraham Lincoln', 'Benjamin Franklin', 'John Adams'],
        category: 'American History',
        subcategory: 'Colonial Period and Independence',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishAnswer: ['George Washington'],
        spanishWrongAns: ['Abraham Lincoln', 'Andrew Jackson', 'John Adams'],
        category: 'American History',
        subcategory: 'Colonial Period and Independence',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['Territorio de Alaska', 'Territorio de Nuevo México', 'Canadá'],
        category: 'American History',
        subcategory: "1800's",
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['Segunda Guerra Mundial', 'Guerra Revolucionaria', 'Guerra de Corea'],
        category: 'American History',
        subcategory: "1800's",
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['Guerra de Corea', 'Guerra Revolucionaria', 'Guerra de 1812'],
        category: 'American History',
        subcategory: "1800's",
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['Comunismo', 'Libertad de religión', 'Bibliotecas libres'],
        category: 'American History',
        subcategory: "1800's",
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['Fundó los Estados Unidos', 'Fue el primer presidente', 'Dirigió los Estados Unidos durante la Segunda Guerra Mundial'],
        category: 'American History',
        subcategory: "1800's",
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['Dio a las mujeres el derecho al voto', 'Declaró la guerra', 'Dio la independencia a EE.UU.'],
        category: 'American History',
        subcategory: "1800's",
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['Luchó por el fin de la esclavitud', 'Se convirtió en presidente de los Estados Unidos', "Luchó contra los Nazis"],
        category: 'American History',
        subcategory: "1800's",
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['Guerra de 1812', 'Guerra Revolucionaria Americana', 'Guerra Civil'],
        category: 'American History',
      ...
      },
      {
        ...
        spanishWrongAns: ['Theodore Roosevelt', 'Rutherford B. Hayes', 'Andrew Johnson'],
        category: 'American History',
        subcategory: 'Recent American History and Other Important Historical Information',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['Abraham Lincoln', 'Andrew Jackson', 'John F. Kennedy'],
        category: 'American History',
        subcategory: 'Recent American History and Other Important Historical Information',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['Canadá, Inglaterra e Irlanda', 'Marruecos, Egipto y Arabia Saudita', 'Rusia, Suecia y Austria'],
        category: 'American History',
        subcategory: 'Recent American History and Other Important Historical Information',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['Primera Guerra Mundial', 'Guerra de Corea', 'Guerra de Vietnam'],
        category: 'American History',
        subcategory: 'Recent American History and Other Important Historical Information',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['Gripe', 'Fascismo', 'Capitalismo'],
        category: 'American History',
        subcategory: 'Recent American History and Other Important Historical Information',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['Revolución Industrial', 'Guerra Civil', 'Convención Constitucional'],
        category: 'American History',
        subcategory: 'Recent American History and Other Important Historical Information',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['Se convirtió en presidente de los Estados Unidos', 'Liberó a los esclavos', 'Estableció el gobierno'],
        category: 'American History',
        subcategory: 'Recent American History and Other Important Historical Information',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['Martin Luther King Jr., lideró el movimiento de derechos civiles', 'George Bush fue elegido', 'Comenzó la Segunda Guerra Mundial'],
        category: 'American History',
        subcategory: 'Recent American History and Other Important Historical Information',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['Maya', 'Inca', 'Zapotec'],
        category: 'American History',
        subcategory: 'Recent American History and Other Important Historical Information',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['Río Amazonas', 'Río Tennessee', 'Río Yukón'],
      ...
      },
      {
        ...
        spanishWrongAns: ['Océano Atlántico', 'Océano Índico', 'Océano Ártico'],
        category: 'Integrated Civics',
        subcategory: 'Geography',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['Océano Pacífico', 'Océano Índico', 'Océano Ártico'],
        category: 'Integrated Civics',
        subcategory: 'Geography',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['Cuba', 'Islandia', 'Haití'],
        category: 'Integrated Civics',
        subcategory: 'Geography',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        answer: ['New York', 'Pennsylvania', 'Ohio', 'Michigan', 'Minnesota', 'Washington', 'Alaska'],
        type: 1,
        wrongAns: ['Wyoming', 'Kentucky', 'North Carolina'],
        spanishQuestion: 'Mencione un estado que tiene frontera con Canadá.',
        spanishAnswer: ['Nueva York', 'Pensilvania', 'Ohio', 'Michigan', 'Minnesota', 'Washington', 'Alaska'],
        spanishWrongAns: ['Wyoming', 'Kentucky', 'Carolina del Norte'],
        category: 'Integrated Civics',
        subcategory: 'Geography',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['Florida', 'Georgia', 'Kansas'],
        category: 'Integrated Civics',
        subcategory: 'Geography',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['Ciudad de Nueva York', 'Chicago', 'Baltimore'],
        category: 'Integrated Civics',
        subcategory: 'Geography',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['Staten Island', 'Washington DC', 'Chicago'],
        category: 'Integrated Civics',
        subcategory: 'Geography',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['Porque ha habido 13 Presidentes', 'Porque ha habido 13 padres fundadores', 'Porque hay 13 enmiendas'],
        category: 'Integrated Civics',
        subcategory: 'Symbols',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['Porque hay 50 senadores', 'Porque hay 50 colonias originales', 'Porque hay 50 presidentes'],
        category: 'Integrated Civics',
        subcategory: 'Symbols',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['America The Beautiful', 'God Bless The USA', 'Yankee Doodle'],
        category: 'Integrated Civics',
        subcategory: 'Symbols',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        spanishWrongAns: ['31 de Diciembre', '5 de Marzo', '1 de Abril'],
        category: 'Integrated Civics',
      ...
      },
      {
        ...
        type: 1,
        wrongAns: ['Easter, Memorial Day', "Valentine's Day, Easter", 'Groundhog Day, Christmas'],
        ...
        spanishWrongAns: ['Pascua, Día de los Caídos', 'Día de San Valentín, Pascua', 'Día de la marmota, Navidad'],
        category: 'Integrated Civics',
        subcategory: 'Holidays',
        createdAt: new Date(),
        updatedAt: new Date()
